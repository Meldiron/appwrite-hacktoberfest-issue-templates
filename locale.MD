# Help Translate Appwrite to Slovak Language ✍️
...
Your task is to translate the Appwrite's templates into **Slovak** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Slovak in `app/config/locale/translations/sk.json`
