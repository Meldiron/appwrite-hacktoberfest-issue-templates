# Help Translate Appwrite to Pashto Language ✍️
...
Your task is to translate Appwrite's templates into **Pashto** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Pashto in `app/config/locale/translations/ps.json`
