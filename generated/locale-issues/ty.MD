# Help Translate Appwrite to Tahitian Language ✍️
...
Your task is to translate Appwrite's templates into **Tahitian** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Tahitian in `app/config/locale/translations/ty.json`
