# Help Translate Appwrite to Ido Language ✍️
...
Your task is to translate Appwrite's templates into **Ido** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Ido in `app/config/locale/translations/io.json`
