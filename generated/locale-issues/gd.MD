# Help Translate Appwrite to Scottish Gaelic Language ✍️
...
Your task is to translate Appwrite's templates into **Scottish Gaelic** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Scottish Gaelic in `app/config/locale/translations/gd.json`
