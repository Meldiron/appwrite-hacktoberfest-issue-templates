# Help Translate Appwrite to Chuvash Language ✍️
...
Your task is to translate Appwrite's templates into **Chuvash** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Chuvash in `app/config/locale/translations/cv.json`
