# Help Translate Appwrite to Amharic Language ✍️
...
Your task is to translate Appwrite's templates into **Amharic** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Amharic in `app/config/locale/translations/am.json`
