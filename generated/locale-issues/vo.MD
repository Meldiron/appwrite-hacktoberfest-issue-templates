# Help Translate Appwrite to Volapük Language ✍️
...
Your task is to translate Appwrite's templates into **Volapük** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Volapük in `app/config/locale/translations/vo.json`
