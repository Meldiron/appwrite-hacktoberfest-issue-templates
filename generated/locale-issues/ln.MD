# Help Translate Appwrite to Lingala Language ✍️
...
Your task is to translate Appwrite's templates into **Lingala** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Lingala in `app/config/locale/translations/ln.json`
