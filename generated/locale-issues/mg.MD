# Help Translate Appwrite to Malagasy Language ✍️
...
Your task is to translate Appwrite's templates into **Malagasy** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Malagasy in `app/config/locale/translations/mg.json`
