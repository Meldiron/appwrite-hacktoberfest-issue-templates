# Help Translate Appwrite to Ossetian / Ossetic Language ✍️
...
Your task is to translate Appwrite's templates into **Ossetian / Ossetic** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Ossetian / Ossetic in `app/config/locale/translations/os.json`
