# Help Translate Appwrite to Old Church Slavonic / Old Bulgarian Language ✍️
...
Your task is to translate Appwrite's templates into **Old Church Slavonic / Old Bulgarian** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Old Church Slavonic / Old Bulgarian in `app/config/locale/translations/cu.json`
