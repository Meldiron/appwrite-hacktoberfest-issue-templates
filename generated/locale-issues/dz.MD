# Help Translate Appwrite to Dzongkha Language ✍️
...
Your task is to translate Appwrite's templates into **Dzongkha** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Dzongkha in `app/config/locale/translations/dz.json`
