# Help Translate Appwrite to Kazakh Language ✍️
...
Your task is to translate Appwrite's templates into **Kazakh** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Kazakh in `app/config/locale/translations/kk.json`
