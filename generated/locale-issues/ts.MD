# Help Translate Appwrite to Tsonga Language ✍️
...
Your task is to translate Appwrite's templates into **Tsonga** language. You can find a complete in-depth tutorial in our official [tutorial for adding translations](https://github.com/appwrite/appwrite/blob/master/docs/tutorials/add-translations.md).

### Tasks summary:

- [ ] Fork & clone Appwrite
- [ ] Generate translations for Tsonga in `app/config/locale/translations/ts.json`
